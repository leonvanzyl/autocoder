...
This is an autonomous coding agent system with a React-based UI. It uses the Opencode SDK to build complete applications over multiple sessions using a two-agent pattern:
...
# To use the Opencode SDK, install it into your environment:
...
- `.opencode/templates/` - Prompt templates copied to new projects
...
2. Create an Opencode client with security settings
